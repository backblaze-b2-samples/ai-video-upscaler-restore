...
from app.runtime import files, health, jobs, metrics, upload  # noqa: E402
...
app = FastAPI(
    title="AI Video Upscaler & Restore API",
    description="Real-ESRGAN video/image restoration archived on Backblaze B2",
    version="0.1.0",
    lifespan=lifespan,
)
